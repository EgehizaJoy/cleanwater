                ...
                <div class="invoice p-5">
                    ...
                    <div class="product border-bottom table-responsive">
                        <table class="table table-borderless">
                            <tbody>
                                <tr>
                                    <td width="20%"> <img src="{{ asset('storage/images/' . $order->image) }}" width="90"> </td>
                                    <td width="60%"> <span class="font-weight-bold">{{$order->product_name}}</span>
                                        <div class="product-qty"> <span class="d-block">Quantity:{{$order->order_qty}} </div>
                                        <div class="product-qty"> <span class="d-block">Quantity:{{$order->order_id}} </div>
                                    </td>
