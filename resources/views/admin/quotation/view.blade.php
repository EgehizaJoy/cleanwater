      ...
      <!--  <form action="quote" method="post">
              ...
              <div class="row">
                ...
                <ul class="list-unstyled">
                        <p>From: <span style="color:#5d9fc5 ;"><b>Quest water</b></span></p>
                        <p><b>Nairobi, westalnds, 27th</b></p>
                        <p><b>questwater@gmail.com</b></p>
                        <p><i class="fas fa-phone"></i><b>0789456765</b></p>
                        </ul>
                        <br><br>
                ...
                @if ($loop->last)
                    ...
                    <ul class="list-unstyled">
                    <p>To: <span style="color:#5d9fc5 ;"><b>{{$order->customer_name}}</b></span></p>
                    <p><b>{{$order->county}}</b></p>
                    <p><b>{{$order->address}}</b></p>
                    <p><i class="fas fa-phone"></i><b>{{$order->phone}}</b></p>
          ...
          <div class="col-md-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <p>Payment Due:<b> {{$order->payment_due}}</b></p>
        ...
        <div class="col-mdxl-8">
          ...
          <div class="col-md-3">
            ...
            <li class="text-muted ms-3"><span class="text-black me-4">SubTotal</span>Ksh. {{$order->subtotal}}</li>
              <li class="text-muted ms-3 mt-2"><span class="text-black me-4">Tax(16%)</span>Ksh. {{ 0.16 * $order->subtotal}}</li>
              </ul>
