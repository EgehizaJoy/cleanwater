  ...
  <div class="card-body">
    <div class="container mb-5 mt-3">
      ...
      <!--  <form action="quote" method="post">
              ...
              <div class="row">
                ...
                @if ($loop->last)
                  ...
                  <div class="form-group mx-sm-3 mb-2">
                    ...
                    <input type="text" class="form-control" style="width:20%"  name="customer_name" id="customer_name"  value="{{$order->user_name}}">
                  </div>

                  <div class="form-group mx-sm-3 mb-2">
                    <input type="text" class="form-control" style="width:20%"  name="county" id="county"  value="{{$order->county}}, {{$order->town}}">
                  </div>

                  <div class="form-group mx-sm-3 mb-2">
                    <input type="text" class="form-control" style="width:20%"  name="address" id="address"  value="{{$order->road}}, {{$order->additional_info}}">
                  </div>
                   
                  <div class="form-group mx-sm-3 mb-2">
                    <input type="phone" class="form-control" style="width:20%"  name="phone" id="phone"  value="{{$order->phone}}">
                  </div>
          ...
          <div class="col-md-4">
          <div class="form-group mx-sm-3 mb-2"><span>Date to deliver</span>
          <input type="date" class="form-control" style="width:40%"id="inputPassword2" placeholder="delivered_date" name="delivery_date"  required>
            </div>

         

            <div class="form-group mx-sm-3 mb-2">
                <input type="number" class="form-control" style="width:40%"id="inputPassword2" placeholder="order ID " name="order_id" value="{{$order->order_id}}">
            </div>
      ...
      <table>
       ...
       @foreach($orders as $order)
        <div class=" add-input">
          ...
          <div class="form-group  col-md-2">
          <p class="form-control">{{$order->unit_price}}</p>
           
          </div>

          <div class="form-group  col-md-2">
          <p class="form-control">{{ $order->quantity * $order->unit_price}}</p>
        ...
        <div class="col-mdxl-8">
          ...
          <div class="col-md-3">
            ...
            @if ($loop->last)
              ...
              <input type="number" style="width:30%" placeholder="subtotals" name="subtotal" value="{{$order->totals}}">
              </li>
            
              <li class="text-muted ms-3 mt-2"><span class="text-black me-4">Tax(16%)</span>Ksh. 
              <input type="number" style="width:30%" placeholder="subtotals" name="tax" value="{{ 0.16 * $order->totals}}">
               </li>
              </ul>
              <p class="text-black float-start"><span class="text-black me-4"> Total Amount</span><span >Ksh. 
              <input type="number" style="width:40%" placeholder="subtotals" name="total" value="{{$order->totals+(0.16 * $order->totals)}}">
            </span></p>
          </div>
        </div>
